...
public class user_ShowTicketAdapter extends RecyclerView.Adapter<user_ShowTicketAdapter.BookingViewHolder> {
    ...
    public user_ShowTicketAdapter(ArrayList<BookingWrapper> bookingHistoryList) {
