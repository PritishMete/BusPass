...
public class user_BookingHistoryActivity extends AppCompatActivity {
    ...
    private void loadBookingHistory(String userPhone) {
        ...
        long oneHourAgoMillis = System.currentTimeMillis() - TimeUnit.DAYS.toMillis(7);
        ...
        bookingsRef.child(userPhone).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (bookingHistoryList.isEmpty()) {
                    Toast.makeText(user_BookingHistoryActivity.this,
